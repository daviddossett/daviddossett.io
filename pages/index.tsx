  ...
  return (
    <Layout>
      <main>
        ...
        <p>I've been at Microsoft since 2016. Before VS Code, I led design for Aria, a real-time analytics app and platform. I also spent time as a developer building the design system for Customer Insights. I learned the ropes at 8ninths working on AR/VR experiences.</p>
        <p>More soon.</p>
